...
/*******************************************************************************
* Function Name: Clock_QD_3_Start
********************************************************************************
*
* Summary:
...
void Clock_QD_3_Start(void) 
{
    ...
    Clock_QD_3_CLKEN |= Clock_QD_3_CLKEN_MASK;
	Clock_QD_3_CLKSTBY |= Clock_QD_3_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: Clock_QD_3_Stop
********************************************************************************
*
* Summary:
...
void Clock_QD_3_Stop(void) 
{
    ...
    Clock_QD_3_CLKEN &= (uint8)(~Clock_QD_3_CLKEN_MASK);
	Clock_QD_3_CLKSTBY &= (uint8)(~Clock_QD_3_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: Clock_QD_3_StopBlock
********************************************************************************
*
* Summary:
...
{
    if ((Clock_QD_3_CLKEN & Clock_QD_3_CLKEN_MASK) != 0u)
    {
        ...
        CLK_DIST_AMASK = Clock_QD_3_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = Clock_QD_3_CLKEN_MASK;
        CLK_DIST_AMASK = 0x00u;
#endif /* Clock_QD_3__CFG3 */

        /* Clear mask of bus clock. */
        CLK_DIST_BCFG2 &= (uint8)(~BCFG2_MASK);

        oldDivider = CY_GET_REG16(Clock_QD_3_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(Clock_QD_3_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: Clock_QD_3_StandbyPower
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: Clock_QD_3_SetDividerRegister
********************************************************************************
*
* Summary:
                                ...
                                
{
    ...
    uint8 currSrc = Clock_QD_3_GetSourceRegister();
    uint16 oldDivider = Clock_QD_3_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = Clock_QD_3_CLKEN & Clock_QD_3_CLKEN_MASK;
        ...
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((Clock_QD_3_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
...
/*******************************************************************************
* Function Name: Clock_QD_3_GetDividerRegister
********************************************************************************
*
* Summary:
...
{
    return CY_GET_REG16(Clock_QD_3_DIV_PTR);
}


/*******************************************************************************
* Function Name: Clock_QD_3_SetModeRegister
********************************************************************************
*
* Summary:
...
{
    Clock_QD_3_MOD_SRC |= modeBitMask & (uint8)Clock_QD_3_MODE_MASK;
}


/*******************************************************************************
* Function Name: Clock_QD_3_ClearModeRegister
********************************************************************************
*
* Summary:
...
{
    Clock_QD_3_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(Clock_QD_3_MODE_MASK));
}


/*******************************************************************************
* Function Name: Clock_QD_3_GetModeRegister
********************************************************************************
*
* Summary:
...
{
    return Clock_QD_3_MOD_SRC & (uint8)(Clock_QD_3_MODE_MASK);
}


/*******************************************************************************
* Function Name: Clock_QD_3_SetSourceRegister
********************************************************************************
*
* Summary:
...
{
    uint16 currDiv = Clock_QD_3_GetDividerRegister();
    uint8 oldSrc = Clock_QD_3_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        Clock_QD_3_MOD_SRC |= CYCLK_SSS;
        Clock_QD_3_MOD_SRC =
            (Clock_QD_3_MOD_SRC & (uint8)(~Clock_QD_3_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: Clock_QD_3_GetSourceRegister
********************************************************************************
*
* Summary:
...
{
    return Clock_QD_3_MOD_SRC & Clock_QD_3_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: Clock_QD_3_SetPhaseRegister
********************************************************************************
*
* Summary:
...
{
    Clock_QD_3_PHASE = clkPhase & Clock_QD_3_PHASE_MASK;
}


/*******************************************************************************
* Function Name: Clock_QD_3_GetPhase
********************************************************************************
*
* Summary:
...
{
    return Clock_QD_3_PHASE & Clock_QD_3_PHASE_MASK;
}
