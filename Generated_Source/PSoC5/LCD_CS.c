...
*
*  LCD_CS_DM_STRONG     Strong Drive 
*  LCD_CS_DM_OD_HI      Open Drain, Drives High 
*  LCD_CS_DM_OD_LO      Open Drain, Drives Low 
*  LCD_CS_DM_RES_UP     Resistive Pull Up 
*  LCD_CS_DM_RES_DWN    Resistive Pull Down 
*  LCD_CS_DM_RES_UPDWN  Resistive Pull Up/Down 
*  LCD_CS_DM_DIG_HIZ    High Impedance Digital 
*  LCD_CS_DM_ALG_HIZ    High Impedance Analog 
*
* Return: 
*  None
*
