...
void SW_Int_SetVector(cyisraddress address)
{
    ...
    ramVectorTable[CYINT_IRQ_BASE + (uint32)SW_Int__INTC_NUMBER] = address;
}
...
cyisraddress SW_Int_GetVector(void)
{
    ...
    return ramVectorTable[CYINT_IRQ_BASE + (uint32)SW_Int__INTC_NUMBER];
}
