                                   ...
                                   
{
        ...
        Counter_1_GLOBAL_ENABLE &= ((uint8)(~Counter_1_BLOCK_EN_MASK));
    #else
        CY_SET_REG24(Counter_1_COUNTER_LSB_PTR, counter);
    #endif /* (Counter_1_UsingFixedFunction) */
}
#endif /* (!(Counter_1_UsingFixedFunction && (CY_PSOC5A))) */
...
uint32 Counter_1_ReadCounter(void) 
{
    ...
    #else
        return (CY_GET_REG24(Counter_1_STATICCOUNT_LSB_PTR));
    #endif /* (Counter_1_UsingFixedFunction) */
}
...
void Counter_1_WritePeriod(uint32 period) 
{
    ...
    #else
        CY_SET_REG24(Counter_1_PERIOD_LSB_PTR, period);
    #endif /* (Counter_1_UsingFixedFunction) */
}
...
uint32 Counter_1_ReadPeriod(void) 
{
    ...
    #else
        return (CY_GET_REG24(Counter_1_PERIOD_LSB_PTR));
    #endif /* (Counter_1_UsingFixedFunction) */
}
                                   ...
                                   
{
    ...
    #else
        CY_SET_REG24(Counter_1_COMPARE_LSB_PTR, compare);
    #endif /* (Counter_1_UsingFixedFunction) */
}
...
{
    return (CY_GET_REG24(Counter_1_COMPARE_LSB_PTR));
}
