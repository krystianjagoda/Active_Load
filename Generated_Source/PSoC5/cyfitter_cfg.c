...
#define BS_UDB_0_1_1_CONFIG_VAL ((const uint8 CYFAR *)0x48000D4Cu)

/* UCFG_BCTL0 Address: CYREG_BCTL0_MDCLK_EN Size (bytes): 16 */
#define BS_UCFG_BCTL0_VAL ((const uint8 CYFAR *)0x48000DCCu)

/* IOPINS0_0 Address: CYREG_PRT0_DM0 Size (bytes): 8 */
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x48000DDCu)
...
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x48000DECu)

/* IOPINS0_1 Address: CYREG_PRT1_DR Size (bytes): 10 */
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)0x48000DF8u)
...
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x48000E0Cu)

/* CYDEV_CLKDIST_ACFG0_CFG0 Address: CYREG_CLKDIST_ACFG0_CFG0 Size (bytes): 8 */
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x48000E14u)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG6_CFG0), 0x12BFu);
	CY_SET_XTND_REG8((void CYFAR *)(CYREG_CLKDIST_DCFG6_CFG0 + 0x2u), 0x19u);
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG7_CFG0), 0x0001u);
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_FASTCLK_PLL_P), 0x0F19u);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)CYREG_PRT2_AMUX, 0xC008u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_CAPSR_CFG0, 0x80u);
...
uint8 CYXDATA * const CYCODE DAC_MUX__addrTable[6] = {
	(uint8 CYXDATA *)CYREG_CMP1_SW3, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE DAC_MUX__maskTable[6] = {
	0x09u, 0x00u, 
	0x80u, 0x00u, 
	0x01u, 0x00u, 
};
...
*
*******************************************************************************/
void DAC_MUX_Set(uint8 channel)
{
	if (channel < 3)
	{
		channel += channel;
		*DAC_MUX__addrTable[channel] |= DAC_MUX__maskTable[channel];
		channel++;
		*DAC_MUX__addrTable[channel] |= DAC_MUX__maskTable[channel];
	}
}
...
*
*******************************************************************************/
void DAC_MUX_Unset(uint8 channel)
{
	if (channel < 3)
	{
		channel += channel;
		*DAC_MUX__addrTable[channel] &= (uint8)~DAC_MUX__maskTable[channel];
		channel++;
		*DAC_MUX__addrTable[channel] &= (uint8)~DAC_MUX__maskTable[channel];
	}
}
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
uint8 CYXDATA * const CYCODE ResistiveTouch_1_ADC_AMux__addrTable[2] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE ResistiveTouch_1_ADC_AMux__maskTable[2] = {
	0x40u, 
	0x00u, 
};

/*******************************************************************************
* Function Name: ResistiveTouch_1_ADC_AMux_Set
********************************************************************************
* Summary:
*  This function is used to set a particular channel as active on the AMux.
*
...
*
*******************************************************************************/
void ResistiveTouch_1_ADC_AMux_Set(uint8 channel)
{
	if (channel < 2)
	{
		*ResistiveTouch_1_ADC_AMux__addrTable[channel] |= ResistiveTouch_1_ADC_AMux__maskTable[channel];
	}
}

/*******************************************************************************
* Function Name: ResistiveTouch_1_ADC_AMux_Unset
********************************************************************************
* Summary:
*  This function is used to clear a particular channel from being active on the
*  AMux.
...
*
*******************************************************************************/
void ResistiveTouch_1_ADC_AMux_Unset(uint8 channel)
{
	if (channel < 2)
	{
		*ResistiveTouch_1_ADC_AMux__addrTable[channel] &= (uint8)~ResistiveTouch_1_ADC_AMux__maskTable[channel];
	}
}
...
void ResistiveTouch_1_AMux_DisconnectAll(void)
{
	...
	CY_SET_REG8((void CYXDATA *)CYREG_CMP3_SW0, 0x40u);
}
...
void ResistiveTouch_1_AMux_Next(void)
{
	...
	case 0:
		...
		CY_SET_REG8((void CYXDATA *)CYREG_CMP3_SW0, 0x40u | 0x04u);
		break;
	case 1:
		CY_SET_REG8((void CYXDATA *)CYREG_PRT1_AG, 0x10u);
		CY_SET_REG8((void CYXDATA *)CYREG_CMP3_SW0, 0x40u | 0x01u);
		break;
	}
}
...
void cyfitter_cfg(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)(CYREG_B0_P3_U1_CFG27), 0x84u);
